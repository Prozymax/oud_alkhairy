// Team member data (same as in team.js)
const teamData = {
    zikrullah: {
...
function loadProfile() {
    ...
    if (!memberId || !teamData[memberId]) {
        // Redirect to team page if invalid member
    ...
    // Update page title
    document.title = `${member.name} - Oud Alkhairy`;
    
    // Update hero section
    document.getElementById('profile-name').textContent = member.name;
    document.getElementById('profile-role-hero').textContent = member.role;
    
    // Update profile header
    document.getElementById('profile-image').src = member.image;
    document.getElementById('profile-image').alt = member.name;
    document.getElementById('profile-role-badge').textContent = member.role;
    document.getElementById('profile-name-main').textContent = member.name;
    
    // Update specializations
    const specializationsContainer = document.getElementById('profile-specializations');
    specializationsContainer.innerHTML = '';
    member.specializations.forEach(spec => {
        const tag = document.createElement('span');
        tag.className = 'profile-specialization-tag';
